        ...
        <div className='HomePage'>
            <div className='hero-section'>
                ...
                <div className='buttons'>
                    <Button id="multiplayer-button" linkTo={ '/multiplayer' } color='primary'>ONLINE MULTIPLAYER</Button>
                    <Button id="local-button" linkTo={ '/local' } color='highlight'>LOCAL PLAY</Button>
                </div>
            </div>
